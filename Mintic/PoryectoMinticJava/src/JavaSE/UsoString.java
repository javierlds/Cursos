...
public class UsoString {
    ...
    // Si comparo con == , comparo son objetos, si es el mismo objeto devuelve verdadero, de lo contrario fals0
    public int comparaStrings2(){
        String cadena1 = "A";
        String cadena2 = "A";
        int compara = cadena1 == cadena2 ? 1 : 0;
        return compara;
    }

    // comparando dos strings con Equals si son iguales devuelve true, de lo contrario false
